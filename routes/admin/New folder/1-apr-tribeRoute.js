...
/*==========================================
 ...
 router.get('/master/folk-media/:categorytype/:tribeid?/:id?', master.masterUplodAllMedia);
 router.post('/master/folk-media/:categorytype/:tribeid?/:id?', master.masterUplodAllMedia);
